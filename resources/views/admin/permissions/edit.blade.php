...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">تعديل الصلاحية</h1>
            ...
            <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $permission->name) }}" required dir="ltr">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('group') is-invalid @enderror" id="group" name="group">
                        ...
                        @endforeach
                        <option value="أخرى" {{ !in_array(old('group', $permission->group), $groups->toArray()) ? 'selected' : '' }}>أخرى</option>
                    </select>
                    @error('group')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
